...
####################################################################################################
# Checkmk ruleset to set the expiration time thresholds for Apple VPP tokens.
...
def _parameter_form_ms_intune_apple_vpp_tokens() -> Dictionary:
    return Dictionary(
...
rule_spec_ms_intune_apple_vpp_tokens = CheckParameters(
